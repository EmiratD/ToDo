...
// SVG можно вставить сюда напрямую или импортировать
function AddTodoButton() {
  const [open, setOpen] = useState(false);

  return (
    <>
      <button className="add-todo-btn" onClick={() => setOpen(true)}>
        {/* SVG-контейнер */}
        <svg
          width="58"
          height="58"
